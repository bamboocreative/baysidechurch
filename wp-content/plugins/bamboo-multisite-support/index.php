...
Version: 1.0
*/ 
// Includes all php files from /customPosts/
foreach (glob(plugin_dir_path( __FILE__ ) . "/customPosts/*.php") as $filename){
	include $filename;
}

foreach (glob(plugin_dir_path( __FILE__ ) . "/customFields/*.php") as $filename){
	include $filename;
}
