			...
			<div class="event-wrapper">
				<div class="row">
					<div class="col-md-12">
						...
						<h1>
						<a href="<?php echo $events['permalink']; ?>"><?php echo $events['title']; ?></a>
						<?php if($events['featured']){ ?><div class="tag-wrapper"><span class="event-tag featured">Featured</span><?php } ?></div>
						</h1>
